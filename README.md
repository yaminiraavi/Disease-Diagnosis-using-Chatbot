...
Email alerts with diagnosis and home remedies
Doctor recommendation with appointment booking
Lifestyle and disease awareness information
...
IDE: PyCharm
Email API: SMTP (for alerts)

HOW TO RUN
1.clone the repository
2.Import the MySQL DB using DB.txt
3.Start the server
4.Open your browser at http://127.0.0.1:8000/index.html
